<template>
    <list class="list" ref="list" @scroll="onScrollHandler" loadmoreoffset=2000>
                ...
                <div class="shopHeader" style="flex-direction:row;">
                    ...
                    <div style="flex:5;flex-direction:row;">
                        <div style="flex-direction:row;margin-left:10px;margin-top:10px;">
                            <div>
                                <image style="width:20px;height:20px;" src="https://img.alicdn.com/tps/i4/TB1zkDeIFXXXXXrXVXX07tlTXXX-200-200.png_88x88xz.jpg"></image>
                            </div>
                            <div>
                        ...
                        <div style="position:absolute;left:90px;top:10px;flex-direction:row;">
                            <div>
                                <image style="width:20px;height:20px;" src="https://img.alicdn.com/tps/i2/TB1hRb1IXXXXXX3XVXXXQaP.pXX-87-87.jpeg"></image>
                            </div>
                            <div>
                        ...
                        <div style="position:absolute;left:170px;top:10px;flex-direction:row;">
                            <div>
                                <image style="width:20px;height:20px;" src="https://img.alicdn.com/tps/i3/TB1DGkJJFXXXXaZXFXX07tlTXXX-200-200.png"></image>
                            </div>
                            <div>
                        ...
                        <div style="position:absolute;left:250px;top:10px;flex-direction:row;">
                            <div>
                                <image style="width:20px;height:20px;" src="https://img.alicdn.com/tps/i1/TB1nFvPIXXXXXbUXXXXUAkPJpXX-87-87.png"></image>
                            </div>
                            <div>
                        ...
                        <div style="position:absolute;left:330px;top:10px;flex-direction:row;">
                            <div>
                                <image style="width:20px;height:20px;" src="https://img.alicdn.com/tps/i2/TB1CpD7IXXXXXbSXXXXUAkPJpXX-87-87.png"></image>
                            </div>
                            <div>
                        ...
                        <div style="position:absolute;left:410px;top:10px;flex-direction:row;">
                            <div>
                                <image style="width:20px;height:20px;" src="https://gtms02.alicdn.com/tps/i2/TB11ZZfIVXXXXbMXFXXEDhGGXXX-32-32.png"></image>
                            </div>
                            <div>
